                    ...
                    <div class="col-lg-12">
                        <div class="users_details">
                            <div class="form-group">
                                ...
                                <p><?php echo $users_>users_first_name; ?></p>
                            </div>
                            <div class="form-group">
                                <label for="last_name">Last Name</label>
                                <p><?php echo $users_>users_last_name; ?></p>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <p><?php echo $users_>users_email; ?></p>
                            </div>
                            <div class="form-group">
                                <label for="role">Role</label>
                                <p><?php echo $users_>users_types_name; ?></p>
                            </div>
                            <div class="form-group">
                                <label for="image">Profile Image</label>
                                <img src="<?php echo $users_>images_file; ?>" alt="Profile Image" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
