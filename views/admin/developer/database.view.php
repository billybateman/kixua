<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <h1>Developer Tools - Database</h1>
        </div>
        <div class="card-body">
            <?php
            ...
            function showTables($conn) {
                ...
                if ($result = $conn->query($sql)) {
                    if ($result->num_rows > 0) {
                        echo "<h2>Tables in database:</h2><ul class='list-group'>";
            ...
            function showTableFields($conn, $table) {
                ...
                if ($result = $conn->query($sql)) {
                    if ($result->num_rows > 0) {
                        echo "<h2>Fields in table " . htmlspecialchars($table) . ":</h2><table class='table table-striped'><thead class='thead-dark'><tr><th>Field</th><th>Type</th><th>Null</th><th>Key</th><th>Default</th><th>Extra</th></tr></thead><tbody>";
            ...
            function showTableRows($conn, $table) {
                ...
                if ($result = $conn->query($sql)) {
                    if ($result->num_rows > 0) {
                        echo "<h2>Rows in table " . htmlspecialchars($table) . ":</h2><table class='table table-striped'><thead class='thead-dark'><tr>";
                        // Print table headers
