...
<body>
    ...
    <!-- register -->
    <section class="position-relative pb-0 pt-1">
        <div class="gen-register-page-background" style="background-image: url('assets/images/background/asset-3.jpeg');">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <h4>Register</h4>
                            ...
                            <a href="/login">Login</a> | <a href="/forgot">Lost your password?</a>
                        </form>
                    </div>
                </div>
            </div>
